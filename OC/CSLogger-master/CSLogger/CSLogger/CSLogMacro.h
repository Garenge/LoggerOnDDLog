...
/////////////////////////// 测试
#define CSLOG_TEST_FLAG   (1 << 10)
#define CSLOG_TEST_LEVEL   (CSLOG_TEST_FLAG)
#define CSLOG_TEST_DDLOG(frmt, ...) LOG_MAYBE(LOG_ASYNC_ENABLED, ddLogLevel, CSLOG_TEST_FLAG,CSLOG_TEST_LEVEL, nil, __PRETTY_FUNCTION__, frmt, ##__VA_ARGS__)

#define CSLOG_TEST_FLAG2   (1 << 11)
#define CSLOG_TEST_LEVEL2   (CSLOG_TEST_FLAG2)
